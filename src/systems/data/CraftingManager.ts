import { CRAFTING_ENABLED } from "./ContentAvailability";
...
export class CraftingManager {
    ...
    public getRecipe(recipeId: string): CraftingRecipeDefinition | null {
        if (!CRAFTING_ENABLED) return null;
        ...
        return [
            {
                ...
                inputs: [
                    ...
                    { itemId: "wood", name: "\u6728\u5934", count: 1, icon: "atlas/picture/items/shared/basic-material.png" },
                ],
            ...
            },
            {
                ...
                output: { itemId: "grilled_fish", name: "\u70e4\u9c7c", count: 1, icon: "atlas/picture/items/shared/cooked-food.png" },
            },
            {
                ...
                output: { itemId: "grilled_mushroom", name: "\u70e4\u8611\u83c7", count: 1, icon: "atlas/picture/items/shared/cooked-food.png" },
            },
            {
                ...
                output: { itemId: "grilled_corn", name: "\u70e4\u7389\u7c73", count: 1, icon: "atlas/picture/items/shared/cooked-food.png" },
            },
            {
                ...
                output: { itemId: "grilled_potato", name: "\u70e4\u571f\u8c46", count: 1, icon: "atlas/picture/items/shared/cooked-food.png" },
            },
            {
                id: "campfire_roast",
                station: "campfire",
            ...
            },
            {
                ...
                output: { itemId: "fried_chips", name: "\u85af\u6761", count: 1, icon: "atlas/picture/items/shared/cooked-food.png" },
            },
            {
                id: "campfire_gujiao",
                station: "campfire",
                name: "\u9aa8\u80f6",
                inputs: [
                    { itemId: "shougu", name: "\u517d\u9aa8", count: 2, icon: "atlas/picture/items/shared/basic-material.png" },
                    { itemId: "wood", name: "\u6728\u5934", count: 1, icon: "atlas/picture/items/shared/basic-material.png" },
                ],
            ...
            },
            {
                ...
                inputs: [
                    ...
                    { itemId: "shupi", name: "\u6811\u76ae", count: 1, icon: "atlas/picture/items/shared/basic-material.png" },
                ],
            ...
            },
            {
                ...
                station: "processing",
                name: "\u6728\u677f",
                inputs: [{ itemId: "wood", name: "\u6728\u5934", count: 2, icon: "atlas/picture/items/shared/basic-material.png" }],
            ...
            },
            {
                ...
                output: { itemId: "tieding", name: "\u94c1\u952d", count: 1, icon: "atlas/picture/items/shared/metal-ingot.png" },
            },
            {
                ...
                output: { itemId: "tongding", name: "\u94dc\u952d", count: 1, icon: "atlas/picture/items/shared/metal-ingot.png" },
            },
            {
                id: "equipment_knife",
                station: "equipment",
                name: "\u5c0f\u5200",
                inputs: [
                    { itemId: "tieding", name: "\u94c1\u952d", count: 1, icon: "atlas/picture/items/shared/metal-ingot.png" },
            ...
            },
            {
                ...
                name: "\u68d2\u7403\u68cd",
                inputs: [
                    { itemId: "yingmu", name: "\u786c\u6728", count: 3, icon: "atlas/picture/items/shared/metal-ingot.png" },
            ...
            },
            {
                ...
                station: "equipment",
                name: "\u64ac\u68cd",
                inputs: [{ itemId: "tieding", name: "\u94c1\u952d", count: 4, icon: "atlas/picture/items/shared/metal-ingot.png" }],
            ...
            },
            {
                ...
                name: "\u83dc\u5200",
                inputs: [
                    { itemId: "tieding", name: "\u94c1\u952d", count: 2, icon: "atlas/picture/items/shared/metal-ingot.png" },
                    { itemId: "yingmu", name: "\u786c\u6728", count: 1, icon: "atlas/picture/items/shared/metal-ingot.png" },
            ...
            },
            {
                ...
                name: "\u5927\u780d\u5200",
                inputs: [
                    { itemId: "tieding", name: "\u94c1\u952d", count: 5, icon: "atlas/picture/items/shared/metal-ingot.png" },
                    { itemId: "yingmu", name: "\u786c\u6728", count: 2, icon: "atlas/picture/items/shared/metal-ingot.png" },
            ...
            },
            {
                ...
                output: { itemId: "laoshigangkui", name: "\u8001\u5f0f\u94a2\u76d4", count: 1, icon: "atlas/picture/items/shared/helmet.png" },
            },
            {
                id: "armor_k1_helmet",
                station: "pengrenji",
                ...
                output: { itemId: "k1", name: "K1", count: 1, icon: "atlas/picture/items/shared/helmet.png" },
            },
            {
                id: "armor_g6_helmet",
                station: "pengrenji",
                ...
                output: { itemId: "G6", name: "G6", count: 1, icon: "atlas/picture/items/shared/helmet.png" },
            },
            {
                id: "armor_ce3_helmet",
                station: "pengrenji",
                name: "CE3",
                inputs: [
                    { itemId: "taihejin", name: "\u949b\u5408\u91d1", count: 1, icon: "atlas/picture/items/shared/metal-ingot.png" },
                    { itemId: "tezhonghejin", name: "\u7279\u79cd\u5408\u91d1", count: 2, icon: "atlas/picture/items/materials/advanced_materials/tezhonghejin.png" },
                    { itemId: "gaofenzicailiao", name: "\u9ad8\u5206\u5b50\u6750\u6599", count: 3, icon: "atlas/picture/items/materials/advanced_materials/gaofenzicailiao.png" },
            ...
            },
            {
                ...
                output: { itemId: "k1chaban", name: "K1\u63d2\u677f", count: 1, icon: "atlas/picture/items/shared/armor-plate.png" },
            },
            {
                ...
                name: "FN\u94a2\u677f",
                inputs: [
                    { itemId: "tezhonggang", name: "\u7279\u79cd\u94a2", count: 4, icon: "atlas/picture/items/shared/metal-ingot.png" },
            ...
            },
            {
                ...
                output: { itemId: "G6taociban", name: "G6\u9676\u74f7\u677f", count: 1, icon: "atlas/picture/items/shared/armor-plate.png" },
            },
            {
            ...
            },
            {
                ...
                name: "\u706b\u836f",
                inputs: [
                    { itemId: "xiaoshi", name: "\u785d\u77f3", count: 1, icon: "atlas/picture/items/shared/basic-material.png" },
            ...
            },
            {
                ...
                name: "\u6728\u68d2",
                inputs: [
                    { itemId: "wood", name: "\u6728\u5934", count: 3, icon: "atlas/picture/items/shared/basic-material.png" },
