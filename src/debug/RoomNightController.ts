...
export class RoomNightController extends Laya.Script {
    ...
    private flashlightSource: Laya.Sprite | null = null;
    ...
    public updateAfterFlashlight(): void {
        ...
        if (!this.flashlightSource || this.flashlightSource.destroyed) {
            this.flashlightSource = night.getChildByName("circle_cutout") as Laya.Sprite | null;
        }
        let insideAny = false;
        ...
        for (let index = 0; index < this.rooms.length; index++) {
            ...
            zone.updateFlashlight(this.flashlightSource, world);
        }
