...
export class DebugActionsController {
    ...
    private async runStaminaDrainTest(dataManager: DataManager): Promise<void> {
        ...
        const previousRunRequested = !!joystick.runRequested;
        ...
        try {
            ...
            joystick.runRequested = previousRunRequested;
            player.setRunningState(previousRunRequested);
