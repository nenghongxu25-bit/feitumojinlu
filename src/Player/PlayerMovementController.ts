...
export class PlayerMovementController {
    ...
    public onUpdate(): void {
        ...
        if (!this.joystick) {
            ...
            this.controller.setRunningState(false);
        ...
        // Running follows the current joystick pull, rather than staying toggled.
        this.controller.setRunningState(this.joystick.runRequested);
        ...
        // Locomotion animation follows joystick intent. A blocked or tiny
        // movement step should not flip the character to idle for one frame;
        // that idle/walk restart is especially visible while firing.
    ...
    private moveWithTileBlocking(sprite: Laya.Sprite, dx: number, dy: number): boolean {
        return this.tileBlockMovement.move(sprite, dx, dy, {
            ...
            halfDepth: this.controller.tileBlockHalfDepth,
